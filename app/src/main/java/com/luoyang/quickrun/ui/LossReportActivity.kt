...
import com.luoyang.quickrun.utils.Constants
import com.luoyang.quickrun.utils.Glide4Engine
                    ...
                    .subscribe {
                        if (it) {
                            Matisse.from(this)
                                ...
                                .captureStrategy(CaptureStrategy(false, "com.luoyang.quickrun.fileProvider"))
                                .spanCount(3)
